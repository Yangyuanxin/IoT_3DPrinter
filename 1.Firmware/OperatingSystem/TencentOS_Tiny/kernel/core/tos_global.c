...
timer_ctl_t k_timer_ctl =
{	TOS_TIME_FOREVER, TOS_LIST_NODE(k_timer_ctl.list)};
...
pm_device_ctl_t k_pm_device_ctl =
{	0u};
...
k_tickless_wkup_alarm_t *k_tickless_wkup_alarm[__LOW_POWER_MODE_DUMMY] =
{	K_NULL};
#endif
