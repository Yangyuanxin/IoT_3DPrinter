 ...
 */
__API__ k_err_t tos_mmblk_pool_create(k_mmblk_pool_t *mbp, void *pool_start,
		size_t blk_num, size_t blk_size);
 ...
 * @retval  #K_ERR_NONE                     return successfully.
 */
__API__ k_err_t tos_mmblk_pool_create_dyn(k_mmblk_pool_t **mbp, size_t blk_num,
		size_t blk_size);
