...
__API__ __STATIC_INLINE__ void tos_slist_add_head(k_slist_t *node,
		k_slist_t *slist)
{
...
__API__ __STATIC_INLINE__ void tos_slist_add_tail(k_slist_t *node,
		k_slist_t *slist)
{
	node->next = K_NULL;
...
__API__ __STATIC_INLINE__ void tos_slist_insert(k_slist_t *next_node,
		k_slist_t *new_node, k_slist_t *slist)
{
	if (!next_node)
	{
...
__API__ __STATIC_INLINE__ int tos_slist_contains(k_slist_t *node,
		k_slist_t *slist)
{
	while (slist->next)
	{
