 ...
 */
__API__ k_err_t tos_chr_fifo_create(k_chr_fifo_t *chr_fifo, void *buffer,
		size_t size);
 ...
 * @retval  #K_ERR_NONE         return successfully.
 */
__API__ k_err_t tos_chr_fifo_create_dyn(k_chr_fifo_t *chr_fifo,
		size_t fifo_size);
 ...
 */
__API__ int tos_chr_fifo_push_stream(k_chr_fifo_t *chr_fifo, uint8_t *stream,
		size_t size);
 ...
 */
__API__ int tos_chr_fifo_pop_stream(k_chr_fifo_t *chr_fifo, uint8_t *buffer,
		size_t size);
